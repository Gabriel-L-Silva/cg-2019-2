...
View3::defaultName()
{
  ...
  snprintf(name, sizeof name, "View %d", ++_nextId);
  return name;
}

inline void
View3::error(const std::string& message)
{
...
inline void
View3::updateFocalPoint()
{
  _focalPoint = _position - viewPlaneNormal() * _distance;
}

inline void
View3::updateView(const mat3f& r)
{
...
void
View3::setRotation(const mat3f& r)
{
  _rotation.set(r);
...
void
View3::setPosition(const vec3f& value)
//[]---------------------------------------------------[]
...
void
View3::setEulerAngles(const vec3f& value)
{
...
void
View3::setRotation(const quatf& value)
{
  if (value != _rotation)
  {
    _rotation = value;
...
void
View3::setDirectionOfProjection(const vec3f& value)
//[]---------------------------------------------------[]
...
void
View3::setViewUp(const vec3f& value)
//[]---------------------------------------------------[]
...
void
View3::setProjectionType(ProjectionType value)
//[]---------------------------------------------------[]
...
void
View3::setViewAngle(float value)
//[]---------------------------------------------------[]
...
void
View3::setAspectRatio(float value)
//[]---------------------------------------------------[]
...
void
View3::setClippingPlanes(float F, float B)
//[]---------------------------------------------------[]
...
inline void
View3::rotate(const quatf& rotation)
{
...
void
View3::rotateYX(float ay, float ax, bool orbit)
//[]---------------------------------------------------[]
//|  Rotate YX                                          |
//|                                                     |
...
void
View3::translate(float dx, float dy, float dz)
//[]---------------------------------------------------[]
...
void
View3::setDefaultView(float aspect)
//[]---------------------------------------------------[]
//|  Set default view                                   |
//[]---------------------------------------------------[]
{
...
inline const char*
projectionName(const View3* camera)
//[]---------------------------------------------------[]
//|  Projection name                                    |
//[]---------------------------------------------------[]
{
...
void
View3::print(FILE* f) const
//[]---------------------------------------------------[]
//|  Print camera                                       |
//[]---------------------------------------------------[]
{
  fprintf(f, "View3 name: \"%s\"\n", name());
